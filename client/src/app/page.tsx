...
export default function Home() {
  return (
    <div
      className="min-h-screen p-[100px] flex w-full items-center justify-center bg-cover bg-center bg-no-repeat"
      style={{ backgroundImage: "url('/assets/images/bg.png')" }}
    >
      <div className="bg-[#191818] text-white w-full px-4 sm:px-6 md:px-8 lg:px-10 xl:px-12 py-20 text-center font-slab">
